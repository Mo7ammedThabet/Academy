...
<html  direction="rtl" dir="rtl" style="direction: rtl">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed toolbar-tablet-and-mobile-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">		<!--begin::Main-->
		<!--begin::Root-->
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo">
						<!--begin::Logo-->
						<a href="/home">
							<span style="color:white;font-size:large" class="h-25px logo">{{env('APP_NAME')}}</span>
										...
										<div class="d-flex align-items-center ms-lg-5" id="kt_header_user_menu_toggle">
											...
											<div class="btn btn-active-light d-flex align-items-center bg-hover-light py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												...
												<div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2">
													<span class="text-light fs-7 fw-bold lh-1 mb-2">مرحبا</span>
													<span class="text-light fs-base fw-bolder lh-1">{{session('name')}}</span>
												</div>
												<!--end::Name-->
												<!--begin::Symbol-->
											...
											{{-- <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
													...
													<div class="menu-sub menu-sub-dropdown w-175px py-4">
														...
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="../../demo5/dist/account/statements.html" class="menu-link d-flex flex-stack px-5">Statements
												...
												<!--begin::Menu item-->
												<div class="menu-item px-5">
													<a href="../../demo5/dist/authentication/flows/basic/sign-in.html" class="menu-link px-5">Sign Out</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu separator-->
												<div class="separator my-2"></div>
