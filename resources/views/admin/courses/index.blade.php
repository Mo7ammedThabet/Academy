            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="بحث بعنوان البرنامج ">
                </div>
                <!--end::Search-->
    ...
    <script>
        ...
        var KTDatatablesServerSide = function() {
                    ...
                    columnDefs: [{
                        ...
                        `;
                                if (data.is_publish == 0) {
                                    action += `\
                            <div class="menu-item px-3">
                                    <a href="#" val_id="${data.id}" class="menu-link px-3" data-kt-docs-table-filter="publish_row">
                                    نشر
                                    </a>
                                </div>
                            `
            ...
            var handleDeleteRows = () => {
                ...
                const publishButtons = document.querySelectorAll('[data-kt-docs-table-filter="publish_row"]');
                publishButtons.forEach(d => {
                    // Delete button on click
                    d.addEventListener('click', function(e) {
                        e.preventDefault();
                        // Select parent row
                        ...
                        // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                        Swal.fire({
                            text: "هل أنت نشر من حذف  " + customerName + " ؟",
                            icon: "warning",
                            showCancelButton: true,
                            buttonsStyling: false,
                            ...
                            if (result.value) {
                                ...
                                Swal.fire({
                                    text: customerName + " تم الغاء عملية النشر.",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "حسنًا ، موافق!",
                                    customClass: {
