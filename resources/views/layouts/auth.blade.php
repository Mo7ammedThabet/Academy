            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="nav-profile-image">
                  <img src="{{asset('assets/auth/images/faces/face25.jpg')}}" alt="profile" >
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{route('courses.create')}}">Create Post</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{route('courses.index')}}">Posts</a></li>
                </ul>
              </div>
            </li>
          </ul>
...
<script>
    ...
    swal("Good job!", {{ Session::get('alert-sucess')}}, "success");
    @endif
